...
SPIRITUAL = {
    ...
    "Sonakshi": {
        "path":"Mystic",
        "archetype":"The Midnight Sovereign",
        "indicators":["Scorpio Lagna — nocturnal depth and transformation as native state","Jupiter + Rahu in H12 Libra — liberation through unconventional, non-orthodox wisdom","Mars (Lagna lord) in H8 Gemini — the soul digests and transmutes experience itself","Parivartana Raja Yoga (Sun↔Moon H9↔H10) — dharma and public throne intertwined"],
        "description":"Scorpio Lagna with Mars in the 8th house places transformation at the core of identity — this soul does not observe change, she embodies it. Leo Moon in the 10th house (Purva Phalguni) gives her a regal public presence that arrives through the phoenix arc: the deeper the descent, the higher the rise. Jupiter and Rahu in the 12th house in Libra (Guru-Chandala Yoga) ensure that orthodox spiritual frameworks will never contain her — the mystical path is discovered in liminal spaces, esoteric traditions, and solitary midnight inquiry. The Parivartana Raja Yoga linking the 9th and 10th houses means her dharma and her destiny are one and the same.",
        "strengths":["Transforming personal darkness into wisdom that serves others","Deep psychological insight — reads beneath the surface of every situation","Sovereign stillness under pressure — the eye-of-the-storm quality"],
        "shadow":"The fortress of Scorpio intensity can become a prison — depth without release curdles into control and quiet suspicion",
        "practices":["Tantric or Kundalini Yoga — channeling the H8 serpent energy upward safely","Dark moon practices — journaling, silence, and shadow work on new moon nights","Study of esoteric or cross-cultural mysticism rather than adhering to any single tradition"],
    },
    "Ann CH": {
        "path":"Mystic",
